...
\begin{figure}
\includegraphics{procedure_call_result}
...
\begin{description}
\item [{{c)}}] Results : The table below shows results for reading one
page (4096) . Column 1 and 2 show results without madvise and Columns
3 and 4 show results with madvise 
\item [{{%
\begin{tabular}{|c|c|c|c|}
\hline 
...
\begin{figure}
\includegraphics{bandwidth\lyxdot loopback}
